...
def build_rewrites(
    ...
    [Replacement(old='from foo import bar_pb2 as foo_dot_bar__pb2', new='from ...foo import bar_pb2 as foo_dot_bar__pb2'),
     ...
     Replacement(old='from foo import bar_pb2 as _bar_pb2', new='from ...foo import _bar_pb2 as _bar_pb2')]
    """
    parts = dep.split("/")
    ...
    *import_parts, part = parts
    ...
    replacements = [
        ...
        Replacement(
            ...
            new=f"from {leading_dots}{from_} import _{part}_pb2 as _{part}_pb2",
        ),
    ]
    if is_public:
        replacements.append(
